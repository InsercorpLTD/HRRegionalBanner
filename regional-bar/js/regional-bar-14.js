let banner = {
	...
	'setup':(function(){
		...
		let mobile = '<ul id="mobile" class="notranslate skiptranslate top-dropdown menu-dropdown top-bar" translate="no">';
			...
			mobile += '</li>';
			mobile += '<li>';
				mobile += '<a href="javascript:;" onclick="regionalMobileToggle(\'govt\')" title="Show Local Government"><span class="glyphicon notranslate skiptranslate glyphicon-plus-sign" id="govt-toggle"></span> Local Governments</a>';
		...
		let regional = '<ul id="regional" class="notranslate skiptranslate top-dropdown menu-dropdown top-bar" translate="no"></ul>';
		...
		if(banner.translate === true){
			...
			/*trans += 'function googleTranslateElementInit() {';
				...
				trans += '}';*/
			trans += '</script>';
			trans += '<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>';
		}
		let bar = '<div class="top-bar fixed-bar regional-bar notranslate skiptranslate" translate="no">';
			bar += '<div class="pull-left regional-breadcrumb" translate="no">'; //regional-breadcrumb
				bar += '<span class="region-seal"><a href="https://hrpdcva.gov/" title="Hampton Roads Virginia, America\'s first Region" target="_blank"><img src="https://hrpdcva.gov/templates/regional-bar/img/hr-seal.png" title="Hampton Roads Virginia, America\'s first Region" /><span class="region-text">Hampton Roads, Virginia</span></a></span><!--'; 
			...
			bar += '<ul class="pull-right regional-nav" translate="no">';
				bar += '<li id="regional-link" class="hidden-xs" translate="no">';
					bar += '<a href="javascript:;" onclick="showSub(\'regional\');" class="regional-menu" title="Click to Show Regional Websites"><span class="nav-text"><span class="nav-subtext">Regional</span> Websites</span><span class="glyphicon notranslate skiptranslate glyphicon-option-vertical"></span></a>';
				bar += '</li>';
				bar += '<li id="govt-link" class="hidden-xs" translate="no">';
					bar += '<a href="javascript:;" onclick="showSub(\'govt\');" class="govt-menu" title="Click to Show Localities"><span class="nav-text"><span class="nav-subtext">Local</span> Governments</span><span aria-hidden="true" class="glyphicon notranslate skiptranslate glyphicon-option-vertical"></span></a>';
				bar += '</li>';
				...
				if(banner.translate === true){
					bar += '<li id="translate-link" translate="no">';
						...
						bar += '<a href="javascript:;" onclick="if(jQuery(this).hasClass(\'active\')){ showSub(); }else{ jQuery(\'#google_translate_element>div > div\').trigger(\'click\');showSub(\'translate\');}" id="translate-menu" class="translate-menu" title="Click to Show Translate Options">';
...
function getRegionalLinks(){
	jQuery.ajax({
		url:'https://hrpdcva.gov/regional-banner/',
							...
							html += '<a href="'+pathLink+'" title="'+curLink.title+'" target="_blank">';
								html += '<span class="regional-bar-flex">';
									html += '<span class="regional-bar-image-wrap">';
										html += '<img src="https://hrpdcva.gov'+curLink.image+'" title="'+curLink.title+'" alt="'+curLink.alt+'"/>';
									html += '</span>';
										...
										odd += '<a href="'+pathLink+'" title="'+curLink.title+'" target="_blank">';
											odd += '<span class="regional-bar-flex">';
												odd += '<span class="regional-bar-image-wrap">';
													odd += '<img src="https://hrpdcva.gov'+curLink.image+'" title="'+curLink.title+'" alt="'+curLink.alt+'"/>';
												odd += '</span>';
										...
										even += '<a href="'+pathLink+'" title="'+curLink.title+'" target="_blank">';
											even += '<span class="regional-bar-flex">';
												even += '<span class="regional-bar-image-wrap">';
													even += '<img src="https://hrpdcva.gov'+curLink.image+'" title="'+curLink.title+'" alt="'+curLink.alt+'"/>';
												even  += '</span>';
									...
									if(kLink != undefined){
										...
										html += '<li>'; mobile += '<li>';
											html += '<a href="'+kLink+'" title="'+kidLink.title+'" target="_blank">';
												...
												html += '<span class="regional-bar-flex">';
													html += '<span class="regional-bar-image-wrap">';
														html += '<img src="https://hrpdcva.gov'+kidLink.image+'" title="'+kidLink.title+'" alt="'+kidLink.alt+'"/>';
													html += '</span>';
													html += '<span class="regional-bar-link-text">';
														html += '<span class="regional-bar-link-title">';
															html += kidLink.title;
											...
											if(inc%2 == 0){ 
												odd += '<li>'; 
													odd += '<a href="'+kLink+'" title="'+kidLink.title+'" target="_blank">';
														odd += '<span class="regional-bar-flex">';
															odd += '<span class="regional-bar-image-wrap">';
																odd += '<img src="https://hrpdcva.gov'+kidLink.image+'" title="'+kidLink.title+'" alt="'+kidLink.alt+'"/>';
															odd += '</span>';
															odd += '<span class="regional-bar-link-text">';
																odd += '<span class="regional-bar-link-title">';
																	odd += kidLink.title;
												...
												even += '<li>'; 
													even += '<a href="'+kLink+'" title="'+kidLink.title+'" target="_blank">';
														even += '<span class="regional-bar-flex">';
															even += '<span class="regional-bar-image-wrap">';
																even += '<img src="https://hrpdcva.gov'+kidLink.image+'" title="'+kidLink.title+'" alt="'+kidLink.alt+'"/>';
															even += '</span>';
															even += '<span class="regional-bar-link-text">';
																even += '<span class="regional-bar-link-title">';
																	even += kidLink.title;
...
function populateTranslate(){
	...
	html += '</li>';
	html += '<li><a href="javascript:;" onclick="translatePage(\'en\');" title="Translate to English"><img src="https://hrpdcva.gov/templates/regional-bar/img/flags/united_states.jpg" title="Translate to English" alt="US Flag"/>English (US)</a></li>';
	html += '<li><a href="javascript:;" onclick="translatePage(\'es\');" title="Translate to Spanish"><img src="https://hrpdcva.gov/templates/regional-bar/img/flags/spain.jpg" title="Translate to Spanish" alt="Flag for Spain"/>espa&ntilde;ol (Spanish / Castilian)</a></li>';
	html += '<li><a href="javascript:;" onclick="translatePage(\'fr\');" title="Translate to French"><img src="https://hrpdcva.gov/templates/regional-bar/img/flags/france.jpg" title="Translate to French" alt="Flag for France"/>fran&ccedil;ais (French)</a></li>';
	html += '<li><a href="javascript:;" onclick="translatePage(\'tl\');" title="Translate to Filipino"><img src="https://hrpdcva.gov/templates/regional-bar/img/flags/philippines.jpg" title="Translate to Filipino" alt="Flag for Philippines"/>Tagalog (Filipino)</a></li>';
	html += '<li><a href="javascript:;" onclick="translatePage(\'ko\');" title="Translate to Korean"><img src="https://hrpdcva.gov/templates/regional-bar/img/flags/republic_of_korea.jpg" title="Translate to Korean" alt="Flag for Korea"/>&#xD55C;&#xAD6D;&#xC5B4; / Hanguk-eo (Korean)</a></li>';
	html += '<li><a href="javascript:;" onclick="translatePage(\'vi\');" title="Translate to Vietnamese"><img src="https://hrpdcva.gov/templates/regional-bar/img/flags/vietnam.jpg" title="Translate to Vietnamese" alt="Flag for Vietnam"/>Ti&#x1EBF;ng Vi&#x1EC7;t (Vietnamese)</a></li>';
	html += '<li><a href="javascript:;" onclick="translatePage(\'zh-CN\');" title="Translate to Mandarin"><img src="https://hrpdcva.gov/templates/regional-bar/img/flags/china.jpg" title="Translate to Chinese" alt="Flag for China"/>&#x5B98;&#x8BDD;; &#x5B98;&#x8A71;; / Gu&#257;nhu&agrave; (Mandarin)</a></li>';
	html += '<li><a href="javascript:;" onclick="translatePage(\'ar\');" title="Translate to Arabic"><img src="https://hrpdcva.gov/templates/regional-bar/img/flags/ara.jpg" title="Translate to Arabic" alt="Flag for Saudi Arabia"/>&#x644;&#x639;&#x64E;&#x631;&#x64E;&#x628;&#x650;&#x64A;&#x64E;&#x651;&#x629; / &#x639;&#x64E;&#x631;&#x64E;&#x628;&#x650;&#x64A;&#x651; arabiyy / al-\'arabiyyah (Arabic)</a></li>';
	html += '<li><a href="javascript:;" onclick="translatePage(\'de\');" title="Translate to German"><img src="https://hrpdcva.gov/templates/regional-bar/img/flags/germany.jpg" title="Translate to German" alt="Flag for Germany"/>Deutsch (German)</a></li>';
	html += '<li><a href="javascript:;" onclick="translatePage(\'ru\');" title="Translate to Russian"><img src="https://hrpdcva.gov/templates/regional-bar/img/flags/russia.jpg" title="Translate to Russian" alt="Flag for Russian"/>&#x440;&#x443;&#x441;&#x441;&#x43A;&#x438;&#x439; &#x44F;&#x437;&#x44B;&#x43A; (Russian)</a></li>';
...
function changeGoogleStyles() {
	if($('.goog-te-menu-frame').contents().find('.goog-te-menu2').length) {
		...
		link.rel  = 'stylesheet';
		link.type = 'text/css';
		link.href = '//hrpdcva.gov/templates/regional-bar/css/regional-bar-translate.css';
		link.media = 'all';
