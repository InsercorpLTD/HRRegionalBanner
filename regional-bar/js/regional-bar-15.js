	...
	'setup':(function(){
		...
		let bar = '<div class="top-bar fixed-bar regional-bar notranslate skiptranslate" translate="no">';
			bar += '<div class="pull-left regional-breadcrumb" translate="no">'; //regional-breadcrumb
				bar += '<span class="region-seal"><a href="https://www.hrpdcva.gov/" title="Hampton Roads Virginia, America\'s first Region" target="_blank"><img src="https://www.hrpdcva.gov/templates/regional-bar/img/hr-seal.png" title="Hampton Roads Virginia, America\'s first Region" /><span class="region-text">Hampton Roads, Virginia</span></a></span><!--'; 
							...
							html += '<a href="'+pathLink+'" title="'+curLink.title+'" target="_blank">';
								html += '<span class="regional-bar-flex">';
									html += '<span class="regional-bar-image-wrap">';
										html += '<img src="https://www.hrpdcva.gov'+curLink.image+'" title="'+curLink.title+'" alt="'+curLink.alt+'"/>';
									html += '</span>';
										...
										odd += '<a href="'+pathLink+'" title="'+curLink.title+'" target="_blank">';
											odd += '<span class="regional-bar-flex">';
												odd += '<span class="regional-bar-image-wrap">';
													odd += '<img src="https://www.hrpdcva.gov'+curLink.image+'" title="'+curLink.title+'" alt="'+curLink.alt+'"/>';
												odd += '</span>';
										...
										even += '<a href="'+pathLink+'" title="'+curLink.title+'" target="_blank">';
											even += '<span class="regional-bar-flex">';
												even += '<span class="regional-bar-image-wrap">';
													even += '<img src="https://www.hrpdcva.gov'+curLink.image+'" title="'+curLink.title+'" alt="'+curLink.alt+'"/>';
												even  += '</span>';
									...
									if(kLink != undefined){
										...
										html += '<li>'; mobile += '<li>';
											html += '<a href="'+kLink+'" title="'+kidLink.title+'" target="_blank">';
												...
												html += '<span class="regional-bar-flex">';
													html += '<span class="regional-bar-image-wrap">';
														html += '<img src="https://www.hrpdcva.gov'+kidLink.image+'" title="'+kidLink.title+'" alt="'+kidLink.alt+'"/>';
													html += '</span>';
													html += '<span class="regional-bar-link-text">';
														html += '<span class="regional-bar-link-title">';
															html += kidLink.title;
											...
											if(inc%2 == 0){ 
												odd += '<li>'; 
													odd += '<a href="'+kLink+'" title="'+kidLink.title+'" target="_blank">';
														odd += '<span class="regional-bar-flex">';
															odd += '<span class="regional-bar-image-wrap">';
																odd += '<img src="https://www.hrpdcva.gov'+kidLink.image+'" title="'+kidLink.title+'" alt="'+kidLink.alt+'"/>';
															odd += '</span>';
															odd += '<span class="regional-bar-link-text">';
																odd += '<span class="regional-bar-link-title">';
																	odd += kidLink.title;
												...
												even += '<li>'; 
													even += '<a href="'+kLink+'" title="'+kidLink.title+'" target="_blank">';
														even += '<span class="regional-bar-flex">';
															even += '<span class="regional-bar-image-wrap">';
																even += '<img src="https://www.hrpdcva.gov'+kidLink.image+'" title="'+kidLink.title+'" alt="'+kidLink.alt+'"/>';
															even += '</span>';
															even += '<span class="regional-bar-link-text">';
																even += '<span class="regional-bar-link-title">';
																	even += kidLink.title;
...
function changeGoogleStyles() {
	if($('.goog-te-menu-frame').contents().find('.goog-te-menu2').length) {
		...
		link.rel  = 'stylesheet';
		link.type = 'text/css';
		link.href = '//www.hrpdcva.gov/templates/regional-bar/css/regional-bar-translate.css';
		link.media = 'all';
