			...
			for (var list_item in list){
				...
				if(scr == 'fed' || scr == 'state'){
					...
					html += '<li class="regional-bar-view-all">';
						if(scr == 'fed'){ 
							allLink = '<a href="https://www.usa.gov/federal-agencies/a" title="View all Federal Government Websites" target="_blank">';
								allLink += 'For a full listing of Federal Government websites click here. <span class="glyphicon glyphicon-new-window"></span>';
							allLink += '</a>';
						}
						if(scr == 'state'){ 
							allLink = '<a href="https://www.virginia.gov/agencies" title="View all Virginia Government Websites" target="_blank">';
